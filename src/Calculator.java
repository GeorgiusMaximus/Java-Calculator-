...
public class Calculator implements ActionListener {
    JFrame frame = new JFrame(" Swaggy Calculator");
    ...
    Calculator() {
        ...
        this.clrButtton = new JButton("C:");
        this.negButton = new JButton("n(-)");
        ...
        this.functionButtons[7] = this.clrButtton;
        ...
        this.clrButtton.setBounds(250, 430, 100, 50);
        ...
        this.frame.add(this.clrButtton);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.clrButtton) {
            this.textfield.setText("");
        }
